...
func tcpserverhandleonline(ctx context.Context, p *Peer, peername string, uniqueid int64) {
...
func tcpserverhandleoffline(ctx context.Context, p *Peer, peername string, uniqueid int64) {
	atomic.AddInt64(&tcpcount, -1)
}
