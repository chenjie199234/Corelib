...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("}")
	p1 := "timeout,conntimeout,hearttimeout,heartprobe " + g.QualifiedGoIdent(timePackage.Ident("Duration"))
	...
	g.P("HeartTimeout:           ", g.QualifiedGoIdent(timePackage.Ident("Duration")), "(hearttimeout),")
	g.P("HeartPorbe:             ", g.QualifiedGoIdent(timePackage.Ident("Duration")), "(heartprobe),")
	g.P("GroupNum:               1,")
	g.P("SocketRBuf:             1024,")
	g.P("SocketWBuf:             1024,")
	g.P("MaxMsgLen:              65535,")
	g.P("MaxBufferedWriteMsgNum: 1024,")
	g.P("}")
	...
	for _, method := range service.Methods {
		...
		g.P("callback,e:=c.cc.Call(ctx,", strconv.FormatInt(int64(r.timeout), 10), ",", pathname, ",reqd,", metadataPackage.Ident("GetAllMetadata"), "(ctx))")
