...
var (
	...
	ErrClosed     = &Error{Code: 1005, Httpcode: http.StatusInternalServerError, Msg: "connection closed"}
	ErrReqmsgLen  = &Error{Code: 1006, Httpcode: http.StatusBadRequest, Msg: "req msg too large"}
	ErrRespmsgLen = &Error{Code: 1007, Httpcode: http.StatusInternalServerError, Msg: "resp msg too large"}
)
