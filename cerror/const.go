...
var (
	...
	ErrTarget          = &Error{Code: 1001, Httpcode: http.StatusServiceUnavailable, Msg: "wrong server,check the server group and name"}
	ErrNoapi           = &Error{Code: 1002, Httpcode: http.StatusNotImplemented, Msg: "api not implement"}
	ErrPanic           = &Error{Code: 1003, Httpcode: http.StatusServiceUnavailable, Msg: "server panic"}
	ErrNoserver        = &Error{Code: 1004, Httpcode: http.StatusServiceUnavailable, Msg: "no servers"}
	ErrDiscoverStopped = &Error{Code: 1005, Httpcode: http.StatusInternalServerError, Msg: "discover stopped"}
	ErrClosed          = &Error{Code: 1006, Httpcode: http.StatusInternalServerError, Msg: "connection closed"}
	ErrReqmsgLen       = &Error{Code: 1007, Httpcode: http.StatusBadRequest, Msg: "req msg too large"}
	ErrRespmsgLen      = &Error{Code: 1008, Httpcode: http.StatusInternalServerError, Msg: "resp msg too large"}
)
